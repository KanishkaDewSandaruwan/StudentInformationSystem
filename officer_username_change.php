...
<form class="edit_page" action="officer_username_change.php" method="POST" style="padding: 3%; font-family: \"Times New Roman\",Times, serif;">
			...
			$sql1=mysqli_query($con,$query1);
				...
				else
				{
					...
					else
					{
						...
						$query3="UPDATE medical_officer SET username='$uname' WHERE username='".$g."'";
