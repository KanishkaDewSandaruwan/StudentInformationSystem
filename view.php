...
<div class="container-fluid ">
      <div class="row p-3" style="border-bottom: 3px solid black; background-color: #0f3460">
        <div class="col-md-9 ">
          <h3 class=""><a class="text-light" style="text-decoration: none;" href="dashboard.php"><b><i class="fas fa-arrow-left mr-3"></i>SEUSL Health Center - View Students Details</b></a></h3>
        </div>
...
if (isset($_POST['submit'])) {
  ...
  $search = $_REQUEST['search_box'];
    ...
    <td><a href="edit.php?sid='.$row['sid'].'">Edit</a></td>
