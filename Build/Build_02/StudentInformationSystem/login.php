...
<body class="body" style="background: url(img/back/4QElO0.jpg);
	...
	<p style="color: white; font-size: 11px;">Dear Student. Do you want Register click here..    <a style="margin-left: 1%;" href="register.php">Register</a></p>
...
<?php
	if(isset($_POST['submit']))
	{
		...
		$loginsql5="SELECT * FROM student_login WHERE regnumber='$regnum' AND password='".md5($password)."'";
