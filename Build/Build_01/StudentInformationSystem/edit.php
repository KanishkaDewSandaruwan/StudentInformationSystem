                ...
                echo '<form class="form_edit" action="edit.php?medical_issu='.$id.'" method="POST">
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control ml-3" name="tratid" placeholder="Treated ID">
                      </div>
                    </div>
...
{
            $id = $_REQUEST['drug_id'];
            $q2 = "SELECT * FROM drugs WHERE drug_id='$id '";
            $res2 = mysqli_query($con,$q2);
              ...
              if($id==$row1['drug_id'])
               {
                 echo '<form class="form_edit" action="edit.php?drug_id='.$id.'" method="POST">
                    <div class="form-row">
                      
                      <div class="form-group col-md-6">
                        <label><b>Drug Code</b></label>
                        <input type="text" class="form-control ml-3" name="drug_code" placeholder="Drug Code">
                      </div>
                    </div>

                    <div class="form-group col-md-6">
                      <label for="desc"><b>Drug Name</b></label>
                  ...
                  <div class="dropdown-divider"></div>
                   ...
                   <button type="button" name="submit" class="btn col-md-3 btn-light"  onclick="window.location.href=\'dashboard.php?id=18\'" style="border-radius:20px;">Goto Back</button>
                  ';


                  if(isset($_POST['submit'])){
                    $drug_codes = $_REQUEST['drug_code'];
                    $drug_name = $_REQUEST['drug_name'];
                    $desc = $_REQUEST['desc'];
                    $availble = $_REQUEST['availble'];

                    function checkDruglist($dlist, $con,$a){
                    ...
                    function updateDruglist($list, $con,$drug_codes,$a,$tid){

                      $array = str_word_count($list, 1, 'àáãç3');
                    ...
                    function checkAvailble($con,$drug_codes,$a){

                      $query3="SELECT * FROM treat";
                      $sql3=mysqli_query($con,$query3);

                      while ($rows1=mysqli_fetch_assoc($sql3)) {
                          $nb = $rows1['nb'];

                        if(checkDruglist($nb,$con,$a) == true){
                          return true;
                        ...
                        if(!empty($drug_codes))
                          {
                            $loginsql="SELECT * FROM drugs WHERE drug_id='".$id."'";
                              $result=mysqli_query($con,$loginsql);
                              $rows=mysqli_fetch_assoc($result);
                              $a = $rows['drug_code'];
                              ...
                              if($a==$drug_codes)
                              {
                                  echo "<script type=\"text/javascript\"> alert(\"This Drug Code is already Here\");</script>";
                              }else{ 

                                    
                                  if(checkAvailble($con,$drug_codes,$a) == true)
                                  {
                                    ...
                                    while ($rows1=mysqli_fetch_assoc($sql3)) {
                                        ...
                                        $tid = $rows1['treat_id'];
                                          ...
                                          if($array = updateDruglist($nb,$con,$drug_codes,$a,$tid)){

                                            $data = $array;
                                          }

                                          $query9="UPDATE treat SET nb='$data' WHERE treat_id='".$tid."'";
                                          mysqli_query($con,$query9);

                                    }

                                    $query3="UPDATE drugs SET drug_code='$drug_codes' WHERE drug_id='".$id."'";
                                      mysqli_query($con,$query3);
                                      echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"dashboard.php?id=18\";</script>";
// 
                                    // updateDruglist($tid,$con,$drug_codes,$a);
                      ...
                      if(!empty($drug_name))
                      {
                        $query3="UPDATE drugs SET drugname='$drug_name' WHERE drug_id='".$id."'";
                        $sql3=mysqli_query($con,$query3);
                        echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"dashboard.php?id=18\";</script>";
                      }
                      ...
                      if(!empty($desc))
                      {
                        $query3="UPDATE drugs SET description='$desc' WHERE drug_id='".$id."'";
                        $sql3=mysqli_query($con,$query3);
                        echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"dashboard.php?id=18\";</script>";
                      }
                      ...
                      if(!empty($availble))
                      {
                        $query3="UPDATE drugs SET availability='$availble' WHERE drug_id='".$id."'";
                        $sql3=mysqli_query($con,$query3);
                        echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"dashboard.php?id=18\";</script>";
                      }
...
else if(isset($_REQUEST['treat_id']))
{
            ...
            $res2 = mysqli_query($con,$q2);
              ...
              if($id==$row1['treat_id'])
               {
                echo '<form class="form_edit" action="edit.php?treat_id='.$id.'" method="POST">
                    <div class="form-row">
                      
                      <div class="form-group col-md-6">
                        <label><b>Student Registration Number</b></label>
                        <input type="text" class="form-control ml-3" name="regnum" placeholder="Student Registration Number">
                      </div>
                    </div>
...
{
            $id = $_REQUEST['sid'];
            $q2 = "SELECT * FROM students WHERE sid='$id '";
            $res2 = mysqli_query($con,$q2);
              ...
              if($id==$row1['sid'])
               {
                echo '<form class="form_edit" action="edit.php?sid='.$id.'" method="POST">
                    <div class="form-row">
                      <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
                      <label for="phone"><b>Student Registration Number</b></label>
                      <input type="text" class="form-control" name="regnum" placeholder="Register Number">
                    </div>

                    <div class="form-group col-md-4">
                      <label for="phone"><b>Faculty</b></label>
                      <input type="text" class="form-control" name="fac" placeholder="Enter Faculty">
                    </div>

                    <div class="form-group col-md-4">
                      <label for="phone"><b>Date of Birth</b></label>
                      <input type="text" class="form-control" name="bday" placeholder="Enter Date of Birth">
                    </div>

                  <div class="dropdown-divider"></div>
                   <button type="submit" name="submit" class="btn col-md-2 btn-light" style="border-radius:20px;">Save Details</button>

                   <button type="button" name="submit" class="btn col-md-3 btn-light"  onclick="window.location.href=\'view.php\'" style="border-radius:20px;">Goto Back</button>
                  ';
                  ...
                  if(isset($_POST['submit'])){
                    ...
                    if(!empty($fname))
                      {
                        $query3="UPDATE students SET full_name='$fname' WHERE sid='".$id."'";
                        $sql3=mysqli_query($con,$query3);
                      ...
                      if(!empty($bday))
                      {
                        $query3="UPDATE students SET dob='$bday' WHERE sid='".$id."'";
                        $sql3=mysqli_query($con,$query3);
                        echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"view.php\";</script>";
                      }
                      ...
                      if(!empty($faculty))
                      {
                        $query3="UPDATE students SET faculty='$faculty' WHERE sid='".$id."'";
                        $sql3=mysqli_query($con,$query3);
                        echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"view.php\";</script>";
                      }
                      ...
                      if(!empty($regnum))
                      {
                          ...
                          $query1="SELECT * FROM students WHERE regnumber='$regnum'";
                          $sql1=mysqli_query($con,$query1);

                          
                            if(mysqli_num_rows($sql1)>0)
                            {
                              echo "<script type=\"text/javascript\"> alert(\"Registeration Number is already Exsisted\");</script>";
                            }
                            else
                            {

                              $query8= "SELECT * FROM students WHERE sid='$id '";
                              $sql8=mysqli_query($con,$query8);
                              $row8 = mysqli_fetch_assoc($sql8);
                              $seg_num=$row8['regnumber'];

                              $query2="SELECT * FROM treat WHERE reg_num='$seg_num'";
                              $sql2=mysqli_query($con,$query2);


                              $query9="SELECT * FROM medical_issue WHERE reg_num='$seg_num'";
                              $sql9=mysqli_query($con,$query9);
                              

                              while ($row = mysqli_fetch_assoc($sql2)) {
                                $trid=$row['treat_id'];
                                $query4="UPDATE treat SET reg_num='$regnum' WHERE treat_id='".$trid."'";
                                mysqli_query($con,$query4);
                              }

                              while ($row9 = mysqli_fetch_assoc($sql9)) {
                                $mid = $row9['medicai_issue_id'];
                                $query5="UPDATE medical_issue SET reg_num='$regnum' WHERE medicai_issue_id='".$mid."'";
                                mysqli_query($con,$query5);
                              }
                               
                              $query3="UPDATE students SET regnumber='$regnum' WHERE sid='".$id."'";
                              mysqli_query($con,$query3);
                      ...
                      if(!empty($emails))
                      {
                        if(filter_var($emails, FILTER_VALIDATE_EMAIL)){
                          ...
                          $query1="SELECT * FROM students WHERE email='$emails'";
                          $sql1=mysqli_query($con,$query1);
                            ...
                            if(mysqli_num_rows($sql1)>0)
                            {
                              ...
                              {
                                $query3="UPDATE students SET email='$emails' WHERE sid='".$id."'";
                                $sql3=mysqli_query($con,$query3);
                                echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location.href='view.php';</script>";
                              }
                        }
                      ...
                      if(!empty($address))
                      {
                        $query3="UPDATE students SET address='$address' WHERE sid='".$id."'";
                        $sql3=mysqli_query($con,$query3);
                        echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"view.php\";</script>";
                      }
                      if(!empty($phone))
                      {
                        if(preg_match("/^([0]([7189])([071628])([0-9])([0-9])([0-9])([0-9])([0-9])([0-9])([0-9]))$/", $phone)){
                            $query3="UPDATE students SET phone_number='$phone' WHERE sid='".$id."'";
                            $sql3=mysqli_query($con,$query3);
                            echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"view.php\";</script>";
                      ...
                      if(!empty($gender))
                      {
                        $loginsql="SELECT * FROM students WHERE sid='".$id."'";
                          $result=mysqli_query($con,$loginsql);
                          $rows=mysqli_fetch_assoc($result);
                          $a = $rows['gender'];
                          ...
                          if($a==$gender)
                          {
                              ...
                              $query3="UPDATE students SET gender='$gender' WHERE sid='".$id."'";
                              $sql3=mysqli_query($con,$query3);
                              echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"view.php\";</script>";
                        }
                      }
